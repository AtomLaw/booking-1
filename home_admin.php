...
<div class="leftother">
	<div class="l">
		<div id="innerLeft" style="margin-top: 225px; margin-right: 10px;font-weight:bold;">
		<?php
			if ($_SESSION['SESS_FIRST_NAME']=="admin"){
			echo '<a href="#1" class="cross-link">View Booker Comments</a><br />';
			echo '<a href="#2" class="cross-link">Monitor Reservation</a><br />';
			echo '<a href="#3" class="cross-link">Generate Reports</a><br />';
			echo '<a href="#4" class="cross-link">Room Inventory</a><br />';
			echo '<a href="#5" class="cross-link">Rooms</a><br />';
...
<!--------------------------------VIEW BOOKER COMMENTS-------------------------------------------------------------------------------------------------------------------------->
						<div class="panel" title="Panel 1">
							    <div class="wrapper">
     							    <h1>BOOKER COMMENTS</h1>
...
<!-----------------------------------END OF VIEW BOOKER MESSAGE----------------------------------------------------------------------------------------------------------------------------------->

<!-----------------------------------START OF MONITOR RESERVATION--------------------------------------------------------------------------------------------------------------------------------->
						<div class="panel" title="Panel 2">
							    <div class="wrapper">
									<h1>MONITOR RESERVATION</h1>
									  <div class="view">
									  <table id="mytable" cellspacing="0">
										  <tr>
										    <td width="150" id="label">Name</td>
										    <td width="90" id="label">Arrival</td>
										    <td width="85" id="label">Departure</td>
										    <td width="96" id="label">Room Type </td>
										    <td width="20" id="label">No. of Nights</td>
							      ...
							      <?php
									...
									while($row = mysql_fetch_array($result2)) {
										...
										echo '<td class="contacts">'.$row['arrival'].' - '.$row['eta'].'</td>';
							  ...
							  <div class="panel" title="Panel 4">
							      ...
							      <div class="view">
									  <table id="mytable" cellspacing="0">
										  <tr>
											...
											<td width="230" id="label">Descripton</td>
											<td width="72" id="label">Image</td>
											<td width="51" id="label">Max Quantity</td>
											<td width="51" id="label">Remaining Rooms</td>
								...
								$result3 = mysql_query("SELECT * FROM room");
									while($row3 = mysql_fetch_array($result3)) {
										...
										echo '<td>'.$row3['qty'].'</td>';
											$roomID = $row3['room_id'];
											$query = mysql_query("SELECT sum(qty_reserve) FROM roominventory where status='Active'  and room_id='$roomID'");
											while($rows = mysql_fetch_array($query))  {
											$sumFeature=$rows['sum(qty_reserve)'];
											}
											$totalDiffFeature = $row3['qty'] - $sumFeature;
											if($totalDiffFeature < 0){
												$totalDiffFeature = 0;
											}
										
										echo '<td>'.$totalDiffFeature.'</td>';
										echo '<td>';
