...
<script src="js/jquery-1.2.1.pack.js" type="text/javascript"></script>
	...
	<script src="js/coda-slider.1.1.1.pack.js" type="text/javascript"></script>
	 <link href="js/timePicker.css" media="screen" rel="stylesheet" type="text/css" />
...
var timeField = jQuery('#time').val();


if(timeField == ''){
  alert("Please select the time you wish to reserve");
  return false;
  }
...
<div class="mainwrapper">
  ...
  <div class="reservation">
	...
	<form method="post" action="reservation1-selectroom.php" name="index" onsubmit="return validateForm()">
	 ...
	 <label style="margin-left: 15px;">End Date : </label>
	  ...
	  <BR />
	  <label style="margin-left: 19px;">Time: </label><INPUT id="time" type="text" name="time" class="ed" style="margin-left:31px;width:105px">
	  <br>
    ...
    <div align="center"><br />
      <a rel="facebox" href="modifyindex.php">Modify</a> / <a href="cancelindex.php">Cancel Reservation  </a>  </div>
	</div>
